...
const SETTING_SCHEMAS: Record<keyof PlatformSettings, z.ZodTypeAny> = {
  ...
  currencyEquivalentEnabled: z.boolean(),
  fxMode: z.enum(["BNR", "MANUAL"]),
  fxManualRate: z.number().min(0).max(100),
  ...
  contactSchedule: z.string().max(200),
  ...
  endingNoticeGeneralEnabled: z.boolean(),
